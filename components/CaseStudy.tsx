      ...
      <MaxWidthWrapper>
        ...
        >
          <div className="grid grid-cols-4 gap-4 p-6 font-bold text-lg border-b border-electric-blue/10">
            <div className="text-[#00008B]">Metric</div>
            <div className="text-[#00008B]">Traditional</div>
            <div className="text-[#00008B]">Logo</div>
            <div className="text-[#00008B]">Improvement</div>
          </div>
        ...
        >
          <p className="text-2xl mb-8 text-[#00008B] max-w-3xl mx-auto">
