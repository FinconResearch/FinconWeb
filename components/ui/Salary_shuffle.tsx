...
export default function SalaryShuffler() {
  ...
  const enhanceText = (text: string) => {
    // Regex to match currency symbols and numbers
  ...
  return (
    <div className={`${spaceGrotesk.className} relative overflow-hidden`}>
      ...
      <div className="h-[120px] md:h-[100px] flex items-center justify-center">
        ...
        >
          <p
            className="text-lg text-black leading-relaxed tracking-wide"
